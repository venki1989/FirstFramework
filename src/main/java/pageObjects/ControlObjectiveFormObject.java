...
public class ControlObjectiveFormObject {
	public static Logger log=LogManager.getLogger(base.class.getName());
	public WebDriver driver;
	ExcelUtils data = new ExcelUtils();

	By OpenControlObjectForm=By.xpath("//.//*[@id='ext-gen155']/div[4]/table/tbody/tr/td[2]/div");
	By ControlObjectNameField=By.xpath("//textarea[@id='id7']");
	...
	By CycleName = By.xpath("//img[@alt='Name']");
	...
	public ControlObjectiveFormObject(WebDriver driver) 
	{
		this.driver=driver;
	}
	...
	{
		return this.driver.findElement(ControlObjectNameField);
	...
	public WebElement ClickAddCycleLink()
	{
		//driver.switchTo().defaultContent();
		return this.driver.findElement(AddCycleLink);
	...
	public WebElement OpenControlObjectiveForm()
	{
		driver.switchTo().frame("MultiWindowIframe1");
		return this.driver.findElement(OpenControlObjectForm);

	}



	public WebElement ControlObjectNameField()
	{
		...
		for(int counter = 0; counter <= framecount2; counter++) {
			...
			WebElement found =driver.findElement(ControlObjectNameField); 
			if(found.isDisplayed()) {
